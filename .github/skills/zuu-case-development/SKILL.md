...
Keep case0's README table row manual. Do not require case0 to adopt numbered-case
...
|------|---------|---------|------------|---------------|
| case0 | `utility_name` | Short foundational purpose. | — | — |
...
For now, maintain this index manually. A later owner-requested Lefthook script will
regenerate numbered-case rows from `__purpose__`, `__depends__`, and public package
metadata while excluding case0 from dynamic discovery. Do not create, configure, or
simulate that hook as part of ordinary case development.
